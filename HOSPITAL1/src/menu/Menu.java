...
public class Menu {
   ...
   private void mostrarMenuPaciente(){
       ...
       System.out.println("2. Ver info personal");
       ...
       switch (opcion) {
           case 1:
             ...
             hospital.mostrarConsultasPaciente(nombrePaciente);
               ...
               break;
           case 2:
               String nombrePaciente2 = USUARIO_PACIENTE;
               hospital.mostrarinfoPaciente(nombrePaciente2);
               break;
           case 3:
    ...
    private void mostrarMenuMedico(){
        ...
        System.out.println("3. Ver info personal");
        System.out.println("4. Consultar usuarios.paciente");
        ...
        switch (opcion) {
            ...
            case 2:
               ...
               hospital.mostrarConsultasMedico(nMedico);
                ...
                break;
                case 3:
                    String nMedico2 = USUARIO_MEDICO;
                    hospital.mostrarinfoMedico(nMedico2);
                    break;
            case 4:
